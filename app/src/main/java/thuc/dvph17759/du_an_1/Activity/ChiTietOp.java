...
public class ChiTietOp extends AppCompatActivity {
    ...
    void GetInfomation()
    {
        ...
        OpDienThoai opDienThoai = (OpDienThoai) getIntent().getSerializableExtra("thongtinsanpham");
        Tensanpham = opDienThoai.getName();
        Giasanpham = opDienThoai.getPrice();
        Hinhanhsanpham = opDienThoai.getImg();
        Motasanpham = opDienThoai.getMota();
