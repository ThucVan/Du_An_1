...
public class ChiTietDienThoai extends AppCompatActivity {
    ...
    void GetInfomation()
    {
        ...
        DienThoai dienThoai = (DienThoai) getIntent().getSerializableExtra("thongtinsanpham");
        Tensanpham = dienThoai.getName();
        Giasanpham = dienThoai.getPrice();
        Hinhanhsanpham = dienThoai.getImg();
        Motasanpham = dienThoai.getDetails();
