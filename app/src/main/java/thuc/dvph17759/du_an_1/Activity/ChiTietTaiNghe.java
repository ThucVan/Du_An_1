...
public class ChiTietTaiNghe extends AppCompatActivity {
    ...
    void GetInfomation()
    {
        ...
        Head_Phone head_phone = (Head_Phone) getIntent().getSerializableExtra("thongtinsanpham");
        Tensanpham = head_phone.getName();
        Giasanpham = head_phone.getPrice();
        Hinhanhsanpham = head_phone.getImg();
        Motasanpham = head_phone.getDetails();
